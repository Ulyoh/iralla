...
function showBusBusStationsOnMap(answer){
	...
	if ((typeof(SubMap._busStationArrays) != 'undefined')
	&& (SubMap._busStationArrays.length>0)
	&& (SubMap._busStationArrays[0]!= '')){
		while(SubMap._busStationArrays.length > 0){
			SubMap._busStationArrays.shift().setMap(null);
		}
	}
