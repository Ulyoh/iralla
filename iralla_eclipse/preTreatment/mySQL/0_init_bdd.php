...
require_once 'access_to_db.php';
	...
	$query = "CREATE TABLE IF NOT EXISTS squares (
		id MEDIUMINT(6) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
		bl_id MEDIUMINT(4) UNSIGNED NOT NULL DEFAULT 9999,
		bl_name TINYTEXT UNSIGNED NOT NULL,
		lat INT(6) NOT NULL DEFAULT 999999,
		lng INT(7) NOT NULL DEFAULT 9999999,
		pt_coords_lat FLOAT(10,8) NOT NULL DEFAULT 999,
		pt_coords_lng FLOAT(10,8) NOT NULL DEFAULT 999,
		prev_index_of_pt(5) SMALLINT UNSIGNED NOT NULL DEFAULT 99999,
		prev_index_of_prev_link(5) SMALLINT UNSIGNED NOT NULL DEFAULT 99999,
		prev_index_of_next_link(5) SMALLINT UNSIGNED NOT NULL DEFAULT 99999,
		prev_link_coords_lat FLOAT(10,8) NOT NULL DEFAULT 999,
		prev_link_coords_lng FLOAT(10,8) NOT NULL DEFAULT 999,
		next_link_coords_lat FLOAT(10,8) NOT NULL DEFAULT 999,
		next_link_coords_lng FLOAT(10,8) NOT NULL DEFAULT 999,
		prev_bs_linked_id(5) SMALLINT UNSIGNED NOT NULL DEFAULT 99999,
		next_bs_linked_id(5) SMALLINT UNSIGNED NOT NULL DEFAULT 99999,
		distance_to_prev_link INT(4) SMALLINT UNSIGNED NOT NULL DEFAULT 9999,
		distance_to_next_link INT(4) SMALLINT UNSIGNED NOT NULL DEFAULT 9999,
		distance_from_first_vertex INT(5) SMALLINT UNSIGNED NOT NULL DEFAULT 99999,
		previous_link_id MEDIUMINT(6) UNSIGNED NOT NULL DEFAULT 999999,
		next_link_id MEDIUMINT(6) UNSIGNED NOT NULL DEFAULT 999999,
