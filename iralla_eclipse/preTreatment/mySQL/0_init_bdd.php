...
require_once 'access_to_db.php';
	...
	$query = "CREATE TABLE IF NOT EXISTS squares (
		...
		lat MEDIUMINT(6) NOT NULL DEFAULT 999999,
		lng MEDIUMINT NOT NULL DEFAULT 999999,
		pt_coords_lat FLOAT(11,8) NOT NULL DEFAULT 999,
		pt_coords_lng FLOAT(11,8) NOT NULL DEFAULT 999,
		prev_index_of_pt SMALLINT UNSIGNED NOT NULL DEFAULT 64999,
		prev_index_of_prev_link SMALLINT UNSIGNED NOT NULL DEFAULT 64999,
		prev_index_of_next_link SMALLINT UNSIGNED NOT NULL DEFAULT 64999,
		prev_link_coords_lat FLOAT(11,8) NOT NULL DEFAULT 999,
		prev_link_coords_lng FLOAT(11,8) NOT NULL DEFAULT 999,
		next_link_coords_lat FLOAT(11,8) NOT NULL DEFAULT 999,
		next_link_coords_lng FLOAT(11,8) NOT NULL DEFAULT 999,
		prev_bs_linked_id SMALLINT UNSIGNED NOT NULL DEFAULT 64999,
		next_bs_linked_id SMALLINT UNSIGNED NOT NULL DEFAULT 64999,
		distance_to_prev_link SMALLINT(4) UNSIGNED NOT NULL DEFAULT 9999,
		distance_to_next_link SMALLINT(4) UNSIGNED NOT NULL DEFAULT 9999,
		distance_from_first_vertex SMALLINT UNSIGNED NOT NULL DEFAULT 64999,
