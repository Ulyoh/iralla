...
$seg_I->name = "I";
$slope = $seg_F->get_slope();
$y_intercept = $seg_F->get_y_intercept();
...
print_r($output_list);
*/
$seg_A = new Segment( 0, 0, 10, 10 );
$seg_A->name = "A";
$seg_B = new Segment( 5, 5, 12, 12 );
$seg_B->name = "B";
$segs = array($seg_A, $seg_B);
$output_list = inter_segments($segs);
