...
$p2 = new Point ( -0.34698, 0.47948758);
$p3 = new Point ( -568.369, -1436.048201);
$p4 = new Point ( -1368.3, -3459.0737);
var_dump ( Point::segment_intersection ( $p1, $p2, $p3, $p4, true ) );
echo "\n";
echo "\n";
...
$p1 = new Point ( 2.369, 7.348201 );
$p2 = new Point ( -568.369, -1436.048201);
$p3 = new Point ( -0.34698, 0.47948758);
$p4 = new Point ( -1368.3, -3459.0737);
var_dump(Point::segment_intersection($p1, $p2, $p3, $p4, true));
echo "\n";
echo"*****************************************\n";
